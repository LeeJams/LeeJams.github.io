...
3. [점검 리포트 — 대응할 API와 확인할 코드 위치](#점검-리포트--대응할-api와-확인할-코드-위치)
4. [자동화의 범위 — AI가 하는 일과 사람이 하는 일](#자동화의-범위--ai가-하는-일과-사람이-하는-일)
5. [자동화 전후의 변화](#자동화-전후의-변화)
6. [남은 과제](#남은-과제)
7. [마치며 — 확인과 대조는 자동화, 결정은 사람](#마치며--확인과-대조는-자동화-결정은-사람)
